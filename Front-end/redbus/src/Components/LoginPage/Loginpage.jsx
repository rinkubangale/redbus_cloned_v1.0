    ...
    <div className="main_div">
      <div className="main_cont">
        ...
        <div className="detail50">
          ...
          <div className="cont2">
            <h3>sign in to avail exciting</h3>
            <h3>discounts and cashbacks!!</h3>
          </div>
